...
interface TripResultPanelProps {
    tripName: string;
    days: TripDay[];
    budget?: BudgetBreakdown; // Left here for type compatibility, but ignored in UI
    onConfirm: () => void;
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden bg-white w-full pointer-events-auto">
            ...
            <div className="flex-1 overflow-y-auto px-3 py-3">
                {days.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-48 text-center bg-gray-50 rounded-xl border border-dashed border-gray-200 mt-4">
