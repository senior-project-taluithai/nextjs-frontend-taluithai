...
export const places: PlaceDetailDto[] = [
  {
    ...
    detail:
      "วัดพระธาตุดอยสุเทพราชวรวิหาร เป็นวัดเก่แก่และมีความสำคัญกับจังหวัดเชียงใหม่ ตั้งอยู่บนดอยสุเทพ",
    detail_en:
      "Wat Phra That Doi Suthep is a Theravada Buddhist temple in Chiang Mai Province, Thailand. The temple is often referred to as 'Doi Suthep' although this is actually the name of the mountain where it's located.",
    province_id: 1,
    latitude: 18.8049,
    longitude: 98.9213,
    best_season: "winter",
    ...
    place_reviews: [
      {
        ...
        rating: 5,
        comment:
          "Absolutely breathtaking! The view from the top is worth every step. Make sure to go early to avoid the crowds.",
        date: "2024-01-15",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Beautiful temple. The architecture is stunning. A bit difficult to find parking though.",
        date: "2024-02-10",
  ...
  },
  {
    ...
    detail:
      "หาดป่าตอง เป็นชายหาดที่มีชื่อเสียงมากที่สุดของเกาะภูเก็ต มีรีสอร์ท ร้านค้า ร้านอาหาร และแหล่งบันเทิงมากมาย...",
    detail_en:
      "Patong is the main tourist resort on the island of Phuket, and is the center of Phuket's nightlife and shopping.",
    province_id: 2,
    latitude: 7.8967,
    longitude: 98.2952,
    best_season: "summer",
  ...
  },
  {
    ...
    detail:
      "พระบรมมหาราชวัง เป็นที่ประทับของพระมหากษัตริย์สมัยรัตนโกสินทร์ และเป็นที่ตั้งของวัดพระศรีรัตนศาสดาราม...",
    detail_en:
  ...
  },
  {
    ...
    detail:
      "อุทยานแห่งชาติเขาสก ครอบคลุมพื้นที่ป่าดิบชื้นที่ใหญ่ที่สุดในภาคใต้ มีเขื่อนรัชชประภาที่สวยงาม...",
    detail_en:
      "Khao Sok National Park is in Surat Thani Province, Thailand. It contains dense virgin jungle, towerlike limestone karst formations and the man-made Cheow Lan Lake.",
    province_id: 4,
    latitude: 8.9175,
    longitude: 98.5305,
    best_season: "rainy",
  ...
  },
  {
    ...
    detail:
      "หาดไร่เลย์ เป็นหาดที่ต้องเดินทางด้วยเรือเท่านั้น มีชื่อเสียงเรื่องหน้าผาหินปูนที่สวยงาม...",
    detail_en:
      "Railay is a large peninsula between the city of Krabi and Ao Nang in Thailand. It is accessible only by boat due to high limestone cliffs cutting off mainland access.",
    province_id: 5,
    latitude: 8.0108,
    longitude: 98.8398,
    best_season: "summer",
  ...
  },
  {
    ...
    detail_en:
      "Chiang Mai's Sunday Walking Street creates a vibrant scene of shopping, food, and culture.",
    province_id: 1,
    latitude: 18.7877,
    longitude: 98.993,
    best_season: "all_year",
  ...
  },
  {
    ...
    detail_en:
      "Chiang Mai Zoo and Aquarium is a 200-acre zoo on the foothills of Doi Suthep.",
    province_id: 1,
    latitude: 18.809,
    longitude: 98.948,
    best_season: "winter",
  ...
  },
  {
    ...
    detail_en:
      "Nimmanhemin Road is the trendiest part of Chiang Mai, full of chic cafes, restaurants, and boutiques.",
    province_id: 1,
    latitude: 18.797,
    longitude: 98.968,
    best_season: "all_year",
  ...
  },
  {
    ...
    detail_en:
      "Mon Jam is a mountaintop farming community with cool weather and sweeping views.",
    province_id: 1,
    latitude: 18.935,
    longitude: 98.822,
    best_season: "winter",
  ...
  },
  {
    ...
    detail_en:
      "Wat Umong is a 700-year-old Buddhist temple in Chiang Mai known for its tunnels and forest setting.",
    province_id: 1,
    latitude: 18.783,
    longitude: 98.951,
    best_season: "all_year",
  ...
  },
  {
    ...
    detail_en:
      "The Grand Canyon Chiang Mai is a man-made water park in an old quarry.",
    province_id: 1,
    latitude: 18.696,
    longitude: 98.893,
    best_season: "summer",
  ...
  },
  {
    ...
    detail_en:
      "The Chiang Mai Night Bazaar is a famous shopping market known for handicrafts and souvenirs.",
    province_id: 1,
    latitude: 18.785,
    longitude: 99.0,
    best_season: "all_year",
  ...
  },
  {
    ...
    detail_en:
      "Royal Park Rajapruek is a large botanical garden in Chiang Mai.",
    province_id: 1,
    latitude: 18.746,
    longitude: 98.925,
    best_season: "winter",
